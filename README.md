...
ZCode IDE linux-x64 全版本逆向拆解：55 个发行版（v2.2.0–v3.12.3）的下载、解包、指纹快照、逐版差异与分析笔记。核心交付物为[工作区快照上传机制分析报告](notes/2026-09-19-工作区快照上传.pdf)（25 页）——基于全部 55 个版本的端到端逆向，覆盖捕获范围、加密管线、同意门演化与披露审计。
