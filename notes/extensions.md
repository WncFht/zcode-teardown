...
- **sharp** (`@img/sharp-linux-x64`, image processing): 2.x under `acp/node_modules/@img/`; dropped 3.1.0; **revived 3.9.1 inside `glm/packages/zcode-cua-plugin/` with the identical sha `fdbcd90b39941fb7`** — same binary re-vendored for computer-use screenshots. sharp 0.34.5 at 3.12.3.
