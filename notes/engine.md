...
`a(x,"name")` 函数名清单：3.1.0=5082 → 3.5.3=7247 → 3.6.5=8234 → 3.9.2=8908 → 3.10.0=9002 → 3.12.3=9361（+85%）。bundle：9.43MB(3.1.0) → 8.99MB(3.2.0，收缩) → 11.73MB(3.4.0，+2.5MB 跳跃) → 13.13MB(3.7.6 峰值) → 11.42MB(3.12.3，3.12.x 瘦身 ~1.2MB)。
