...
| `ssh2/…/sshcrypto.node`                                                                                                                                                       | 2.2.0  | 3.12.3 | NAN/V8，82096 B；hash `c8f8788d…`（≤3.6.5）→ `f85819ee…`（≥3.7.3），重编点收窄至 **3.6.5 → 3.7.3**（3.7.3 为 linux-x64 AppImage 树；3.7.1/3.7.2 若入库可再收窄） |
